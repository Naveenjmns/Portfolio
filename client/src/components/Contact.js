  ...
  return (
    <section className="mb-12">
      ...
      <div className="mb-6 space-x-4">
        ...
        <a href="https://www.linkedin.com/in/naveen-kumar-jmns/" target="_blank" rel="noopener noreferrer" className="text-indigo-600 dark:text-indigo-400 hover:underline">LinkedIn</a>
